...
TASK_TYPE_TO_TRAINING_OUTPUT_NAME = {
    ...
    TaskType.MULTILABEL_CLASSIFICATION: OutputFtrType.DETEXT_CLS_LOGITS,
...
TASK_TYPE_TO_SCORER_TENSOR_SPEC = {
    ...
    TaskType.MULTILABEL_CLASSIFICATION: FTR_TYPE_TO_SCORER_TENSOR_SPEC_CLASSIFICATION,
...
TASK_TYPE_TO_EMBEDDING_GENERATOR_TENSOR_SPEC = {
    ...
    TaskType.MULTILABEL_CLASSIFICATION: EMBEDDING_GENERATOR_TENSOR_SPEC_CLASSIFICATION,
